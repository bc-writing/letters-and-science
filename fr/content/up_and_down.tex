...
%% T DROIT COUCHÉ %%
\cadre{$\vdash$} En logique, le symbole $\vdash$, qui n'est autre qu'un T droit couché, permet d'indiquer qu'une proposition $p$ se déduit d'un ensemble de propriétés $\cal P$. Pour cela, on utilise la notation symbolique ${\cal P} \vdash p$. Indiquons que la signification de \focus{se déduit} va dépendre du type de logique étudié.
